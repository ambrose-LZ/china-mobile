...
; (function ($, window, document, undefined) {
  ...
  Calendar.prototype = {
    ...
    inital: function () { // 初始化
      ...
      this.$arrow_prev_year = this.$calendar_title.find('.arrow-prev-year');
      this.$arrow_next_year = this.$calendar_title.find('.arrow-next-year');
      ...
      if (this.opts.ifSwitch) {
        ...
        this.$arrow_prev_year.bind('click', function () {
          var _date = dateObj.getDate();
        ...
        this.$arrow_next_year.bind('click', function () {
          var _date = dateObj.getDate();
...
//页面上显示当前日期
      this.$calendarDate_item.click(function(){
        self.showHoverInfo($(this)); //显示
        // self.$calendar_today.css({ right: 0, top: 0 }).hide(); //消失
        console.log(1)
      })
    },
